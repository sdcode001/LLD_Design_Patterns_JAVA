...
public class LegacyGateway {
  ...
  public void executeTransaction(double totalAmount, String currency) {
    ...
    System.out.println("LegacyGateway: Transaction executed successfully. Txn ID:" + this.transactionReference);
  }
  
  public boolean checkStatus(long transactionReference) {
    System.out.println("Legacy Gateway: Checking status for ref:" + transactionReference);
